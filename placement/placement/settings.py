...
DATABASES = {
    'default': {
        ...
        'NAME': '/home/nofrills/placementsite/placement/placement.sqlite3' ,                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'kkxnlkr0_*+5(8(8j04=o$35*=o-&amp;-=$^7i6rcy#j@9$obg2my'
...
TEMPLATE_DIRS = (
    ...
    # Always use forward slashes, even on Windows.
    # Don't forget to use absolute paths, not relative paths.
    "/home/nofrills/placementsite/placement/templates"
)
